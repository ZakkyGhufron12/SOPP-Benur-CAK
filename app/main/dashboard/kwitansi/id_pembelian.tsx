        ...
        <html>
          ...
          <body>
            ...
            <div class="card">
              ...
              <div class="row"><span class="label">Nomor Telepon Penjual:</span> <span class="value">${kwitansi.nomor_telepon_penjual}</span></div>
            </div>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.value}>{kwitansi.nomor_telepon_penjual}</Text>
      </View>
